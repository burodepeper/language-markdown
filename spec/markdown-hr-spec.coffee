describe 'Markdown grammar', ->
  ...
  it 'tokenizes horitontal rules', ->
    ...
    expect(tokens[0]).toEqual value: '***', scopes: ['text', 'hr.md']

    {tokens} = grammar.tokenizeLine('---')
    expect(tokens[0]).toEqual value: '---', scopes: ['text', 'hr.md']

    {tokens} = grammar.tokenizeLine('___')
    expect(tokens[0]).toEqual value: '___', scopes: ['text', 'hr.md']
    ...
    expect(tokens[0]).toEqual value: '__', scopes: ['text']
    ...
    expect(firstLineTokens[0]).toEqual value: 'Foo', scopes: ['text']
    expect(secondLineTokens[0]).toEqual value: '    ***', scopes: ['text']

    # http://spec.commonmark.org/0.22/#example-15
    {tokens} = grammar.tokenizeLine('_____________________________________')
    expect(tokens[0]).toEqual value: '_____________________________________', scopes: ['text', 'hr.md']
    ...
    expect(tokens[0]).toEqual value: '_ _ _ _ a', scopes: ['text']

    {tokens} = grammar.tokenizeLine('a------')
    expect(tokens[0]).toEqual value: 'a------', scopes: ['text']
    ...
    {tokens} = grammar.tokenizeLine(' *-*')
    # expect(tokens[0]).toEqual value: ' ', scopes: ['text']
    # expect(tokens[1]).toEqual value: '*', scopes: ['text', 'emphasis.md']
    # expect(tokens[2]).toEqual value: '-', scopes: ['text', 'emphasis.md']
    # expect(tokens[3]).toEqual value: '*', scopes: ['text', 'emphasis.md']
    ...
    # expect(firstLineTokens[0]).toEqual value: '-', scopes: ['text', "unordered.list.md", "punctuation.md"]
    # expect(firstLineTokens[1]).toEqual value: ' foo', scopes: ['text', "unordered.list.md"]
    # expect(secondLineTokens[0]).toEqual value: '***', scopes: ['text', 'hr.md']
    # expect(thirdLineTokens[0]).toEqual value: '-', scopes: ['text', "unordered.list.md", "punctuation.md"]
    # expect(thirdLineTokens[1]).toEqual value: ' bar', scopes: ['text', "unordered.list.md"]

    # http://spec.commonmark.org/0.22/#example-23
    [firstLineTokens, secondLineTokens, thirdLineTokens] = grammar.tokenizeLines("Foo\n***\nbar")
    expect(firstLineTokens[0]).toEqual value: 'Foo', scopes: ['text']
    expect(secondLineTokens[0]).toEqual value: '***', scopes: ['text', 'hr.md']
    expect(thirdLineTokens[0]).toEqual value: 'bar', scopes: ['text']
    ...
    # expect(firstLineTokens[0]).toEqual value: '-', scopes: ['text', "unordered.list.md", "punctuation.md"]
    # expect(firstLineTokens[1]).toEqual value: ' Foo', scopes: ['text', "unordered.list.md"]
    # expect(secondLineTokens[0]).toEqual value: '-', scopes: ['text', "unordered.list.md", "punctuation.md"]
    # expect(secondLineTokens[1]).toEqual value: ' * * *', scopes: ['text', "unordered.list.md", "hr.md"]
